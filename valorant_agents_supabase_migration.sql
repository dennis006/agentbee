...
('Reyna', 'a3bfb853-43b2-7238-a4f1-ad90e9e46bcc', 'Reyna', 'Duelist', '#8A2BE2', '{"hoist": false, "mentionable": true, "permissions": [], "position": 7}', 3),
...
('Viper', '707eab51-4836-f488-046a-cda6bf494859', 'Viper', 'Controller', '#006400', '{"hoist": false, "mentionable": true, "permissions": [], "position": 7}', 31),
